...
@section('store_route', route('sponsers.store'))
    ...
    <div class="card card-custom">
        ...
        <div class="card-body">
            ...
            <div class="col form-group">
                <label>@lang('sponser.logo')</label>
                <input type="file" name="logo" placeholder="@lang('sponser.logo')" class="form-control">
            </div>

            <input type="hidden" name="type" value="sponser" id="">
