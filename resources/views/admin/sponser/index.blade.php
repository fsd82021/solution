...
@section('module_name') @lang('general.aside.sponsers') @endsection
@section('permission', 'organization')
@section('title') @lang('general.aside.sponsers') @endsection
@section('create_route') {{route('sponsers.create')}} @endsection
        ...
        <tbody>
         @foreach($data as $key => $value)
            <tr>
                ...
                <td>
                    @include('admin.components.table-control', ['permission' => 'organization', 'name'=>'sponsers', 'value'=>$value])
                </td>
